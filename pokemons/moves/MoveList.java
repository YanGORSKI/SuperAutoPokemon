...
public enum MoveList {
    ...
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        ...
        QUICK_ATTACK	("Quick Attack",	PokeType.NORMAL,	Range.MELEE,	40,    1.0,	1,		1, 		0, 		0,		0.05,	0,		Stats.ATK,		null,		0.0,	0.0,		null,					0),
        FURY_ATTACK	    ("Fury Attack",	PokeType.NORMAL,	Range.MELEE,	15,    0.8,	5,		1, 		0, 		0,		0.05,	0,		Stats.ATK,		null,		0.0,	0.0,		null,					0),
        WRAP	        ("Wrap",	        PokeType.NORMAL,	Range.MELEE,	15,    0.9,	1,		5, 		0, 		0,		0.05,	0,		Stats.ATK,		null,		0.0,	1.0,		Condition.BOUND,					0),
                                                                                                    
    //	DEBUFF MOVES                                                                               
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        GROWL			("Growl",			PokeType.NORMAL,	Range.RANGED,	0,	0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.ATK,		-0.2,	1,			null,					0),
        TAIL_WHIP		("Tail Whip",		PokeType.NORMAL,	Range.RANGED,	0,	0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.DEF,		-0.2,	1,			null,					0),
        LEER			("Leer",			PokeType.NORMAL,	Range.RANGED,	0,	0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.DEF,		-0.2,	1,			null,					0),
        SAND_ATTACK		("Sand Attack",	PokeType.NORMAL,	Range.RANGED,	0,	1.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.ACC,	    -0.2,	1,			null,			        0),
    
    //	BUFF MOVES                                                                               
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        GROWTH			("Growth",		PokeType.NORMAL,	Range.SELF,		0,	    0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.SPECIAL,	        0.2,	1,			null,			0),
        WITHDRAW		("Withdraw",		PokeType.NORMAL,	Range.SELF,		0,	    0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.DEF,	            0.2,	1,			null,			0),
        AGILITY		    ("Agility",		PokeType.NORMAL,	Range.SELF,		0,	    0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.SPD,	            0.2,	1,			null,			0),
        FOCUS_ENERGY	("Focus Energy",	PokeType.NORMAL,	Range.SELF,	    0,	    0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.CRIT,	            0.05,	1,			null,			0),
        DOUBLE_TEAM		("Double Team",	PokeType.NORMAL,	Range.SELF,	    0,	    0.0,	1,		1, 		0, 		0,		0.0d,	0,		null,		Stats.EVS,	            0.2,	1,			null,			0),
    ...
    //  BUG
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        STRING_SHOT		("String Shot",	PokeType.BUG,	Range.RANGED,	    0,	    0.9,	1,		1, 		0, 		0,		0.00,	0,		null,	    Stats.SPD,                      -0.2,	 1,	null,					0),

    //  ELECTRIC
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        THUNDER_SHOCK	("Thunder Shock",	PokeType.ELECTRIC,	Range.RANGED,   40,	1.0,	1,		1, 		0, 		0,		0.05,	0,		Stats.SATK,	    null,       0.0,    0.1,	    Condition.PARALYZED,	        0),
        THUNDERBOLT	    ("Thunderbolt",	PokeType.ELECTRIC,	Range.RANGED,   90,	1.0,	1,		1, 		0, 		0,		0.05,	0,		Stats.SATK,	    null,       0.0,    0.1,	    Condition.PARALYZED,	        0),

    //  FLYING
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        GUST	        ("Gust",	        PokeType.FLYING,	Range.RANGED,   40,	1.0,	1,		1, 		0, 		0,		0.05,	0,		Stats.SATK,	    null,       0.0,    0.0,	    null,	            0),
        PECK	        ("Peck",	        PokeType.FLYING,	Range.MELEE,    35,	1.0,	1,		1, 		0, 		0,		0.05,	0,		Stats.ATK,	    null,       0.0,    0.0,	    null,	            0),
    ...
    //	POISON                                                                                    
    //	ID				NAME				    TYPE				RANGE			    PWR	        ACC		    hits	        trns 	        dlay	      rst		            Crit	        Recoil	stat		        t.stat		                  value	               %efct	  CONDITION				              EXTRA DMG
        POISON_POWDER	("Poison Powder",	PokeType.POISON,	Range.RANGED,	0,	    0.2,	1,		1, 		0, 		0,		0.00,	0,		null,		null,		0.0,	1.0,	Condition.POISONED,		0),
        POISON_STING	("Poison Sting",	PokeType.POISON,	Range.MELEE,	15,	1.0,	1,		1, 		0, 		0,		0.05,	0,		Stats.ATK,		   null,		0.0,	0.3,	Condition.POISONED,		0);
